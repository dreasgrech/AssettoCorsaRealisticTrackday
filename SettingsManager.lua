...
SettingsManager.rampSpeed_mps        = 2.0
...
local SETTINGS_SPEC = {
    ...
    { k = 'rampSpeed_mps', get = function() return SettingsManager.rampSpeed_mps end, set = function(v) SettingsManager.rampSpeed_mps = v end },
