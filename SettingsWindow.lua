...
local drawAICarValuesSection = function()
    ...
    createDisabledSection(not overrideOriginalAIDifficultyLevel_drivingNormally, function()
        storage_AICarValues.defaultAIDifficultyLevel =  renderSlider('Difficulty Level while driving normally', 'The default difficulty level cars exhibit when driving on the default driving lane.\n\nThe higher this value is, the more effective the cars will be with the pedals and how fast they can handle corners.', storage_AICarValues.defaultAIDifficultyLevel, StorageManager_options_min[StorageManager_Options_AICarValues.DefaultAIDifficultyLevel], StorageManager_options_max[StorageManager_Options_AICarValues.DefaultAIDifficultyLevel], DEFAULT_SLIDER_WIDTH, DEFAULT_SLIDER_FORMAT, StorageManager_options_AICarValues_default[StorageManager_Options_AICarValues.DefaultAIDifficultyLevel])
    end)
    ...
    createDisabledSection(not overrideOriginalAIDifficultyLevel_overtaking, function()
        storage_AICarValues.AIDifficultyLevel_OvertakingWithNoObstacleInFront = renderSlider('Difficulty Level while overtaking (No obstacle in front)', 'The difficulty level used when overtaking another car if there is no obstacle in front of the overtaking car.\n\nThe higher this value is, the more effective the cars will be with the pedals and how fast they can handle corners while overtaking when there is no obstacle in front of them.', storage_AICarValues.AIDifficultyLevel_OvertakingWithNoObstacleInFront, StorageManager_options_min[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithNoObstacleInFront], StorageManager_options_max[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithNoObstacleInFront], DEFAULT_SLIDER_WIDTH, DEFAULT_SLIDER_FORMAT, StorageManager_options_AICarValues_default[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithNoObstacleInFront])
        storage_AICarValues.AIDifficultyLevel_OvertakingWithObstacleInFront = renderSlider('Difficulty Level while overtaking (Obstacle in front)', 'The difficulty level used when overtaking another car if there is an obstacle in front of the overtaking car.\n\nThe lower this value is, the less effective the cars will be with the pedals and how fast they can handle corners while overtaking when there is an obstacle in front of them.', storage_AICarValues.AIDifficultyLevel_OvertakingWithObstacleInFront, StorageManager_options_min[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithObstacleInFront], StorageManager_options_max[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithObstacleInFront], DEFAULT_SLIDER_WIDTH, DEFAULT_SLIDER_FORMAT, StorageManager_options_AICarValues_default[StorageManager_Options_AICarValues.AIDifficultyLevel_OvertakingWithObstacleInFront])
        storage_AICarValues.AIDifficultyLevel_WhileInCorner = renderSlider('Difficulty Level while overtaking in corner', 'The difficulty level used when overtaking another car while in a corner.\n\nThe lower this value is, the less effective the cars will be with the pedals and how fast they can handle corners while overtaking in corners.', storage_AICarValues.AIDifficultyLevel_WhileInCorner, StorageManager_options_min[StorageManager_Options_AICarValues.AIDifficultyLevel_WhileInCorner], StorageManager_options_max[StorageManager_Options_AICarValues.AIDifficultyLevel_WhileInCorner], DEFAULT_SLIDER_WIDTH, DEFAULT_SLIDER_FORMAT, StorageManager_options_AICarValues_default[StorageManager_Options_AICarValues.AIDifficultyLevel_WhileInCorner])
    end)
    ...
    createDisabledSection(not overrideOriginalAIDifficultyLevel_yielding, function()
        storage_AICarValues.AIDifficultyLevel_Yielding = renderSlider('Difficulty Level while yielding', 'The difficulty level used when yielding (giving way to faster cars).\n\nThe lower this value is, the less effective the cars will be with the pedals and how fast they can handle corners while yielding.', storage_AICarValues.AIDifficultyLevel_Yielding, StorageManager_options_min[StorageManager_Options_AICarValues.AIDifficultyLevel_Yielding], StorageManager_options_max[StorageManager_Options_AICarValues.AIDifficultyLevel_Yielding], DEFAULT_SLIDER_WIDTH, DEFAULT_SLIDER_FORMAT, StorageManager_options_AICarValues_default[StorageManager_Options_AICarValues.AIDifficultyLevel_Yielding])
    end)
